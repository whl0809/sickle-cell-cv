...
six_class_model_path = 'best_model_vit_torch_macos_seven.pth'
...
pair_model_C.load_state_dict(torch.load("OG1_siamese_vit_c_Haolin.pt", map_location=device))
...
pair_model_F.load_state_dict(torch.load("siamese_vit_ISC_Haolin.pt", map_location=device))
...
pair_model_All.load_state_dict(torch.load("siamese_vit_All_Haolin.pt", map_location=device))
