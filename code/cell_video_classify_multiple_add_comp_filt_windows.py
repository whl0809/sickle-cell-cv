...
for idx, video_path in enumerate(video_paths):
    ...
    #cell_info1,df1=process_video(video_path, video_id=f"V{idx+1}", output_video_path=output[idx],six_class_model,binary_model,feature_extractor,transform,cellpose_model_path = 'cyto3_train0327')
