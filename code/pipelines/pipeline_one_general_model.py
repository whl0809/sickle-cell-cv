...
# pair_model_path_D = str(MODELS_DIR / "siamese_vit_Reti_Haolin.pt")  # Haolin's model
...
# pair_model_path_G = str(MODELS_DIR / "siamese_vit_ISC_Haolin.pt")  # Haolin's model
...
pair_model_path_All = str(MODELS_DIR / "siamese_vit_All_Haolin.pt")  # Haolin's model
