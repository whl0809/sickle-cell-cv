...
def process_video(video_path, out_path, video_id, output_video_path,seven_class_model,binary_model,feature_extractor,transform,cellpose_model_path = 'cyto3_train0327',frame_skip=frame_skip,max_frame=max_frame,fps=fps):
    # ========= 视频初始化 =========
