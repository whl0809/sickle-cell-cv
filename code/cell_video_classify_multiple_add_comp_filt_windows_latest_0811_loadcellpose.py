...
binary_model_path_F = 'best_model_vit_torch_macos_raw_vit_large_binary_F.pth'
binary_model_path_F_brandon = "direct_vit_F.pt"
...
pair_model_C.load_state_dict(torch.load("siamese_vit_c_Haolin.pt", map_location=device))
