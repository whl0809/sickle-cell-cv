...
binary_model_path_D = str(MODELS_DIR / "direct_vit_E.pt")
binary_model_path_F = str(MODELS_DIR / "best_model_vit_torch_macos_raw_vit_large_binary_G.pth")
binary_model_path_F_brandon = str(MODELS_DIR / "direct_vit_G.pt")
